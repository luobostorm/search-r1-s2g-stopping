...
\hypersetup{
  ...
  pdftitle={When Should Multi-Round RAG Stop? Candidate Reachability, Policy Risk, and Retrieval Cost}
}
...
\title{When Should Multi-Round RAG Stop?\\Candidate Reachability, Policy Risk, and Retrieval Cost}
\author{Weimeng Luo\\
